...
public class UserTypeAdapter extends RecyclerView.Adapter<UserTypeAdapter.MyView> {

    private ArrayList<HashMap<String, String>> arrayList;

    private Context mcon;

    public UserTypeAdapter(Context context, ArrayList<HashMap<String, String>> arrayList) {
        mcon = context;
    ...
    public void onBindViewHolder(final MyView holder, final int position) {
        ...
        holder.tv_grade.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("user_type", _id);
                editor.apply();

                Intent i = new Intent(mcon, SelectGradeActivity.class);
