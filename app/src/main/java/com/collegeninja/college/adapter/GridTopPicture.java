...
import java.util.HashMap;
 ...
 public class GridTopPicture extends RecyclerView.Adapter<GridTopPicture.MyView> {
    ...
    public void onBindViewHolder(final MyView holder, final int position) {
        ...
        Picasso.with(mcon).load(arrayList.get(position).get("thumb_img")).placeholder(R.drawable.logo).error(R.drawable.logo).fit().networkPolicy(NetworkPolicy.NO_CACHE).into(holder.pic);
